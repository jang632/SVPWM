...
HD_PWD='C:/Users/Jan/Desktop/SVPWM/svpwm/svpwm/svpwm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log svpwm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source svpwm.tcl -notrace
