...
HD_PWD='C:/Users/Jan/Desktop/SVPWM/svpwm/svpwm/svpwm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log svpwm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source svpwm.tcl
