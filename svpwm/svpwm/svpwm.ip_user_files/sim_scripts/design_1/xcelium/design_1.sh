...
#
# Script generated by Vivado on Sat Aug 02 20:28:31 +0200 2025
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_17 -libname processing_system7_vip_v1_0_19 -libname xil_defaultlib -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_15 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../svpwm.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../svpwm.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../svpwm.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../svpwm.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../svpwm.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../svpwm.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../svpwm.gen/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../svpwm.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../svpwm.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../svpwm.gen/sources_1/bd/design_1/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_19 $xmvlog_opts -sv +incdir+"../../../../svpwm.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../svpwm.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../svpwm.gen/sources_1/bd/design_1/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../svpwm.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"../../../../svpwm.gen/sources_1/bd/design_1/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
